    ...
    specs: list[dict[str, Any]] = [
        {
            ...
            "instructions": [
                ...
                f"Treat todo writeback as a transition invariant, not only setup or closeout. Before moving to a dependent step, persist any material scope, acceptance, or non-goal delta in the current todo evidence and the next executable todo, then run `{cli_bin} refresh-state` and verify quota readback. Chat/model summaries are not durable state.",
