    ...
    *,
    ...
    try:
        ...
        if args.turn_command == "plan":
            ...
            def admit_managed_start(identity: Mapping[str, Any]) -> dict[str, Any]:
                ...
                if admitted.get("admitted") is True:
                    ensure_turn_heartbeat_settlement_receipt(
                        runtime_root,
                        settlement_identity,
                ...
                return {
                    key: admitted.get(key)
                    for key in (
                        "admitted", "reserved", "reason", "next_eligible_at_ms",
            ...
            payload = run_loopx_turn_once(
                ...
                admit_start=admit_managed_start if args.execute else None,
            )
        else:
